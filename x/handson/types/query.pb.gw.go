...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 1, 2, 2}, []string{"linnefromice", "handson", "params"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Pool_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"linnefromice", "handson", "pool", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_PoolAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 1, 2, 2}, []string{"linnefromice", "handson", "pool"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_PoolBalances_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 1, 2, 2}, []string{"linnefromice", "handson", "pool_balances"}, "", runtime.AssumeColonVerbOpt(true)))
)
