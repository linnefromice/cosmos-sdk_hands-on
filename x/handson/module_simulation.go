...
import (
	...
	"github.com/linnefromice/handson/testutil/sample"
	handsonsimulation "github.com/linnefromice/handson/x/handson/simulation"
...
var (
	_ = sample.AccAddress
	_ = handsonsimulation.FindAccount
...
func (AppModule) GenerateGenesisState(simState *module.SimulationState) {
	...
	handsonGenesis := types.GenesisState{
		Params: types.DefaultParams(),
		// this line is used by starport scaffolding # simapp/module/genesisState
	}
	simState.GenState[types.ModuleName] = simState.Cdc.MustMarshalJSON(&handsonGenesis)
}
...
func (am AppModule) WeightedOperations(simState module.SimulationState) []simtypes.WeightedOperation {
	...
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgDeposit,
		handsonsimulation.SimulateMsgDeposit(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgWithdraw,
		handsonsimulation.SimulateMsgWithdraw(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgCreatePool,
		handsonsimulation.SimulateMsgCreatePool(am.accountKeeper, am.bankKeeper, am.keeper),
	))
